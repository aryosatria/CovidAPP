package com.aryosatria.covapp.fragment;
...
import com.aryosatria.covapp.viewmodel.RingkasanViewModel;
...
public class RingkasanFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getSummaryWorldData().observe(this, ringkasanModel -> {
